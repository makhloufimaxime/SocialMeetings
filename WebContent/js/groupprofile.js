...
function renderInformation(){
	...
	var groupAdmin = getUser(group.admin);
	var html = "<a href=\"http://localhost:8080/SocialMeetings/profile.html?email=" + groupAdmin.email + "\">" + groupAdmin.email + "</a> " + groupAdmin.firstname + " " + groupAdmin.lastname;
	$('#admin').html(html);
}
